    ...
    const int length7,const int length8,const int length9,const int length10)
{
        ...
        || (length10 != length_[10]))
    {
        ...
        if (numElements())
        {
            const Range overlap0 = Range(fromStart, (extrema::min)(B.ubound(0), ubound(0)));
            const Range overlap1 = Range(fromStart, (extrema::min)(B.ubound(1), ubound(1)));
            const Range overlap2 = Range(fromStart, (extrema::min)(B.ubound(2), ubound(2)));
            const Range overlap3 = Range(fromStart, (extrema::min)(B.ubound(3), ubound(3)));
            const Range overlap4 = Range(fromStart, (extrema::min)(B.ubound(4), ubound(4)));
            const Range overlap5 = Range(fromStart, (extrema::min)(B.ubound(5), ubound(5)));
            const Range overlap6 = Range(fromStart, (extrema::min)(B.ubound(6), ubound(6)));
            const Range overlap7 = Range(fromStart, (extrema::min)(B.ubound(7), ubound(7)));
            const Range overlap8 = Range(fromStart, (extrema::min)(B.ubound(8), ubound(8)));
            const Range overlap9 = Range(fromStart, (extrema::min)(B.ubound(9), ubound(9)));
            const Range overlap10 = Range(fromStart, (extrema::min)(B.ubound(10), ubound(10)));
            B(overlap0, overlap1, overlap2, overlap3, overlap4, overlap5,
